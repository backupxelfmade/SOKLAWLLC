...
import { Calendar, Clock, User, ExternalLink, AlertCircle, ArrowLeft, BookOpen } from 'lucide-react';
      ...
      <div className="pt-20 min-h-screen" style={{ backgroundColor: '#f5f5f0' }}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
            ...
            <div className="text-center">
              ...
              <p className="text-lg md:text-xl max-w-3xl mx-auto text-gray-600 leading-relaxed">
                Browse through all our legal insights, case victories, and important legal developments
              </p>
              <div className="w-24 h-1 bg-gradient-to-r from-yellow-500 to-yellow-400 mx-auto mt-4"></div>
            </div>
          </div>
        </div>
        ...
        <section ref={sectionRef} className="py-12 md:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {isLoading && (
              <NewsLoader 
                message="Loading all news and articles..." 
                variant="cards"
              />
            )}
